...
This is the FALLBACK path. The normal path is sync_to_github.py, which pushes
project-side/synced/ and lets the project's GitHub connector pull on its own.
Both scripts read TRACKED_FILES from here.
...
TRACKED_FILES = [
    "matthew_study_style_reference.md",
