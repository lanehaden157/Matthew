...
Generated from `data/threads.json` (version 1). 22 threads, 21 open.
...
|---|---|---|---|---|---|---|
| `emmanuel` | `with` | meta / Emmanouēl | with — God-with-us | 1 (1:23) | 28 (28:20) | open |
| `save` | `save` | sōzō | save / heal / rescue | 1 (1:21) | 9 (9:21-22) · 14 (14:30) · 27 (27:42) | open |
| `apo-tote` | `apo-tote` | apo tote | "from that time" | 4 (4:17) | 17 (16:21) | open |
| `fish` | `fish` | halieus | fisher | 4 (4:19) | 13 (13:47) | open |
| `follow` | `follow` | akoloutheō | follow (after) | 4 (4:20) | 8 (8:23) · 9 (9:9, 19, 27) | open |
| `light` | `light` | phōs | light | 4 (4:16) | 5 (5:14) · 6 (6:23) | open |
| `nations` | `nations` | ethnē | nations / Gentiles | 4 (4:15) | 28 (28:19) | open |
...
| `authority` | `authority` | exousia | authority | 7 (7:29) | 8 (8:9) · 9 (9:6, 8) · 28 (28:18) | open |
| `build-rock` | `build` | oikodomeō / petra | build / rock | 7 (7:24) | 16 (16:18) | open |
| `wise-foolish` | `wise-foolish` | phronimos / mōros | wise vs. foolish | 7 (7:24-26) | 25 (25:2) | open |
